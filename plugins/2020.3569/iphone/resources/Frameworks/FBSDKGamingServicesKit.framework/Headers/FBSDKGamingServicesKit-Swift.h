...
/// \param delegate The receiver’s delegate.
///
+ (FBSDKChooseContextDialog * _Nonnull)showChooseContextDialogWithContent:(FBSDKChooseContextContent * _Nonnull)content delegate:(id <FBSDKContextDialogDelegate> _Nonnull)delegate SWIFT_DEPRECATED_MSG("This method is deprecated and will be removed in the next major release. Use the instance method `makeAndShowChooseContextDialog(content:delegate:)` instead");
/// Convenience method to build up and show an instant games choose context dialog with content and a delegate.
/// \param content The content for the choose context dialog
///
/// \param delegate The receiver’s delegate.
...
/// \param delegate The receiver’s delegate.
///
+ (FBSDKSwitchContextDialog * _Nullable)switchContextDialogWithContent:(FBSDKSwitchContextContent * _Nonnull)content delegate:(id <FBSDKContextDialogDelegate> _Nullable)delegate SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("This method is deprecated and will be removed in the next major release. Use the instance method `makeAndShowSwitchContextDialog(content:delegate:)` instead");
@end
...
@interface FBSDKGameRequestContent : NSObject <FBSDKSharingValidation, NSSecureCoding>
...
///   </li>
/// </ul>
+ (nonnull instancetype)dialogWithContent:(FBSDKSwitchContextContent * _Nonnull)content windowFinder:(id <_FBSDKWindowFinding> _Nonnull)windowFinder delegate:(id <FBSDKContextDialogDelegate> _Nonnull)delegate SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("This method is deprecated and will be removed in the next major release. Use the initializer `init(content:windowFinder:delegate:)` instead");
...
/// An internal representation of tournament graph objects. Use <code>Tournament</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
SWIFT_CLASS("_TtC22FBSDKGamingServicesKit16_FBSDKTournament")
@interface _FBSDKTournament : NSObject
...
@class _FBSDKTournamentConfig;

/// An internal wrapper for sharing tournaments via dialog. Use <code>ShareTournamentDialog</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
SWIFT_CLASS_NAMED("_ShareTournamentDialog")
@interface _FBSDKShareTournamentDialog : NSObject
...
///   </li>
/// </ul>
/// \param score A score to share in the tournament could be a numeric score or time interval
/// dependent on the given tournament score type
///
/// \param tournamentID The ID of the  tournament to share and update with the given score
///
- (BOOL)showWithScore:(NSInteger)score tournamentID:(NSString * _Nonnull)tournamentID error:(NSError * _Nullable * _Nullable)error;
/// Attempts to show the share dialog to share an existing tournament
/// <ul>
///   <li>
///     throws  Will throw if an error occurs when attempting to show the dialog
...
/// dependent on the given tournament score type
///
/// \param tournament The tournament to share and update with the given score
///
- (BOOL)showWithScore:(NSInteger)score tournament:(_FBSDKTournament * _Nonnull)tournament error:(NSError * _Nullable * _Nullable)error;
...
///   </li>
/// </ul>
/// \param initialScore An initial score to share, could be a numeric score or time interval
/// dependent on the tournament configuration
///
/// \param config The tournament configuration used to create a new tournament
///
- (BOOL)showWithInitialScore:(NSInteger)initialScore config:(_FBSDKTournamentConfig * _Nonnull)config error:(NSError * _Nullable * _Nullable)error;
- (BOOL)isAuthenticationURL:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
- (BOOL)application:(UIApplication * _Nullable)application open:(NSURL * _Nullable)url sourceApplication:(NSString * _Nullable)sourceApplication annotation:(id _Nullable)annotation SWIFT_WARN_UNUSED_RESULT;
- (BOOL)canOpen:(NSURL * _Nonnull)url for:(UIApplication * _Nullable)application sourceApplication:(NSString * _Nullable)sourceApplication annotation:(id _Nullable)annotation SWIFT_WARN_UNUSED_RESULT;
- (void)applicationDidBecomeActive:(UIApplication * _Nonnull)application;
- (void)didFailWithError:(NSError * _Nonnull)error dialog:(ShareTournamentDialog * _Nonnull)dialog;
- (void)didCancelWithDialog:(ShareTournamentDialog * _Nonnull)dialog;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// An internal protocol for sharing tournaments. Use <code>ShareTournamentDialog</code> and <code>ShareTournamentDialogDelegate</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
SWIFT_PROTOCOL_NAMED("_ShareTournamentDialogDelegate")
@protocol _FBSDKShareTournamentDialogDelegate
- (void)didCompleteWithDialog:(_FBSDKShareTournamentDialog * _Nonnull)dialog tournament:(_FBSDKTournament * _Nonnull)tournament;
- (void)didFailWithError:(NSError * _Nonnull)error dialog:(_FBSDKShareTournamentDialog * _Nonnull)dialog;
- (void)didCancelWithDialog:(_FBSDKShareTournamentDialog * _Nonnull)dialog;
@end


/// An internal object for configuring tournament share dialogs. Use <code>TournamentConfig</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
SWIFT_CLASS_NAMED("_TournamentConfig")
@interface _FBSDKTournamentConfig : NSObject
...
/// An internal class for fetching tournament objects. Use <code>TournamentFetcher</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
SWIFT_CLASS_NAMED("_TournamentFetcher")
@interface _FBSDKTournamentFetcher : NSObject
/// Attempts to fetch all the tournaments where the current logged in user is a participant ;
/// \param completionHandler The caller’s completion handler to invoke once the graph request is complete
///
- (void)fetchTournamentsWithCompletionHandler:(void (^ _Nonnull)(NSArray<_FBSDKTournament *> * _Nullable, NSError * _Nullable))completionHandler;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// An internal enum for different methods of tournament scoring . Use <code>TournamentScoreType</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
typedef SWIFT_ENUM_NAMED(NSInteger, _FBSDKTournamentScoreType, "_TournamentScoreType", open) {
  _FBSDKTournamentScoreTypeNumeric = 0,
  _FBSDKTournamentScoreTypeTime = 1,
};

/// An internal enum for sorting tournament scores. Use <code>TournamentSortOrder</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
typedef SWIFT_ENUM_NAMED(NSInteger, _FBSDKTournamentSortOrder, "_TournamentSortOrder", open) {
  _FBSDKTournamentSortOrderHigherIsBetter = 0,
  _FBSDKTournamentSortOrderLowerIsBetter = 1,
};


/// An internal class for fetching tournament objects. Use <code>TournamentUpdater</code> instead.
/// warning:
/// For internal use only! Subject to change or removal at any time.
SWIFT_CLASS_NAMED("_TournamentUpdater")
@interface _FBSDKTournamentUpdater : NSObject
/// Updates the given tournament with the given score
/// \param tournamentID The ID of the tournament you want to update
///
/// \param score The new score to update within the tournament
///
/// \param completionHandler The caller’s completion handler to invoke once the graph request is complete. Completes with <code>true</code> if successful.
///
- (void)updateWithTournamentID:(NSString * _Nonnull)tournamentID score:(NSInteger)score completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler;
/// Updates the given tournament with the given score
/// \param tournament The tournament you want to update
///
/// \param score The new score to update within the tournament
///
/// \param completionHandler The caller’s completion handler to invoke once the graph request is complete. Completes with <code>true</code> if successful.
///
- (void)updateWithTournament:(_FBSDKTournament * _Nonnull)tournament score:(NSInteger)score completionHandler:(void (^ _Nonnull)(BOOL, NSError * _Nullable))completionHandler;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
